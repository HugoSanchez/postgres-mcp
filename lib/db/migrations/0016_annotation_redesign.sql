-- Drop old annotation-related tables
DROP TABLE IF EXISTS "Highlight";
--> statement-breakpoint
DROP TABLE IF EXISTS "Annotation";
--> statement-breakpoint

-- Create new unified Annotation table
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "annotation_document_idx" ON "Annotation" USING btree ("documentId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "annotation_user_idx" ON "Annotation" USING btree ("userId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "annotation_document_user_idx" ON "Annotation" USING btree ("documentId","userId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "annotation_section_idx" ON "Annotation" USING btree ("documentId","sectionIndex");
--> statement-breakpoint
